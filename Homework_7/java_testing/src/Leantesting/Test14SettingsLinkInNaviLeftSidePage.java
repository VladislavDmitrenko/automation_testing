...
public class Test14SettingsLinkInNaviLeftSidePage {
    ...
    @Test
    public void testSettingsLinkInNaviLeftSidePage() throws Exception {
        driver.get(baseUrl + "/");
        ...
        Thread.sleep(3000);
        try {
            assertEquals("TestProject", driver.findElement(By.cssSelector("#Seamless_Project_name > span.seamless-view.triggerable")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        try {
            assertEquals("Project settings | Lean Testing", driver.getTitle());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
